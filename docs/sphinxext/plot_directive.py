"""
Note: this is taken straight from matplotlib. I would import this if I could, but I
don't think that's possible
https://github.com/matplotlib/matplotlib/blob/v3.6.2/lib/matplotlib/sphinxext/plot_directive.py
